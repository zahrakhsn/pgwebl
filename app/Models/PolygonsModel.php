...
class PolygonsModel extends Model
{
    ...
    {
        $polygons =  $this
        ->select(DB::raw('polygons.id, st_asgeojson(polygons.geom) as geom, polygons.name, polygons.description, polygons.image, st_area(geom, true) as luas_m2, st_area(geom, true)/1000000 as luas_km2,
